@section('title', __('Créez votre Site Web de Restaurant et Menu Digital avec QR Code | TResto Maroc'))
@section('description',
  __('Avec TResto, créez facilement un site web pour votre restaurant au Maroc. Générez des QR codes personnalisés et recevez des commandes en ligne via WhatsApp ou votre site web. Aucun frais de commission, simple et rapide.'))
        ...
        <div class="container px-4 mx-auto relative">
          <div class="relative z-20">
            <h1
              ...
              <span>{{ __('Créez votre propre site web de restaurant en quelques clics avec') }} <span class="text-secondary">TResto</span>
            </h1>
            <p class="text-center text-white text-lg mb-10 max-w-xl mx-auto">
              {{ __('Créez un menu digital, générez des QR codes, recevez des commandes en ligne via votre site ou WhatsApp – sans aucune commission.') }}
            </p>
