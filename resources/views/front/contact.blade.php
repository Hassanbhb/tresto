      ...
      <div class="flex flex-wrap -mx-4">
        <div class="w-full lg:w-1/2 p-4">
          <div class="max-w-xl mx-auto">
            ...
            data-aos-delay="300"
            data-aos-duration="1000"
            data-aos-easing="ease-in-out" class="rounded-3xl border border-gray-100 shadow-sm py-8">
              <div class="relative">
        ...
        data-aos-delay="200"
        data-aos-duration="1000"
        data-aos-easing="ease-in-out" class="w-full lg:w-1/2 p-4">
          <form action="">
      ...
      <div class="flex flex-wrap -mx-4">
        ...
        <div class="w-full lg:w-2/3 p-4">
          <div class="space-y-4">
            ...
            data-aos-delay="100"
            data-aos-duration="1000"
            data-aos-easing="ease-in-out" class="group [&_summary::-webkit-details-marker]:hidden bg-white rounded-3xl">
              <summary
