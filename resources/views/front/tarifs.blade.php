@section('title', __('Tarifs TResto au Maroc: Créez un Site Web de Restaurant sans Commissions'))
@section('description', __("Choisissez une offre TResto adaptée à votre restaurant au Maroc. Créez votre site web, gérez votre menu digital, et recevez des commandes sans frais de commission. Profitez d'un essai gratuit dès maintenant."))
  ...
  <x-layouts.front>
    ...
    <div class="">
      ...
      <section id="pricing" class="py-24">
        <div class="container mx-auto px-4">
          <div data-aos="fade-up" data-aos-offset="100" data-aos-delay="50" data-aos-duration="1000" data-aos-once="true"
        ...
        <div class="flex flex-wrap -mx-4">
          <div data-aos="fade-up" data-aos-offset="150" data-aos-delay="50" data-aos-duration="1000"
            ...
            <div
              ...
              <p class="text-gray-600 pb-40">
                {{ __("Créez votre compte en un clin d'œil ! Il vous suffit de quelques informations, et vous êtes prêt à partir. Aucun besoin de carte de crédit pour commencer.") }}
              </p>
          ...
          <div data-aos="fade-up" data-aos-offset="150" data-aos-delay="200" data-aos-duration="1000"
            data-aos-easing="ease-in-out" class="w-full lg:w-1/3 p-4">
            <div
              class="border border-tresto-500 bg-white rounded-3xl px-4 lg:px-10 py-6 lg:py-12 relative overflow-hidden h-full max-w-md mx-auto">
              <div class="py-1 px-2 rounded-lg bg-tresto-500 inline-flex items-center gap-2 mb-6">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewbox="0 0 16 16"
                  ...
                  <path
                    ...
                    fill="white"></path>
                  <path
                    d="M7.99996 4.66669V11.3334C6.15996 11.3334 4.66663 9.84002 4.66663 8.00002C4.66663 6.16002 6.15996 4.66669 7.99996 4.66669Z"
                    fill="white"></path>
                </svg>
              ...
              <p class="text-gray-600 pb-40">
                {{ __('Ajoutez vos plats, ajustez les prix, et choisissez un design qui vous plaît. Notre interface est super intuitive, donc tout est prêt en un rien de temps.') }}
              </p>
              <div class="absolute -bottom-6 right-4">
          ...
          <div data-aos="fade-up" data-aos-offset="150" data-aos-delay="400" data-aos-duration="1000"
            data-aos-easing="ease-in-out" class="w-full lg:w-1/3 p-4">
            <div
              class="border border-tresto-500 bg-white rounded-3xl px-4 lg:px-10 py-6 lg:py-12 relative overflow-hidden h-full max-w-md mx-auto">
              <div class="py-1 px-2 rounded-lg bg-tresto-500 inline-flex items-center gap-2 mb-6">
              ...
              <p class="text-gray-600 pb-40">
                {{ __("Mettez votre menu en ligne et commencez à recevoir des commandes tout de suite. Vous gérez tout depuis un tableau de bord clair et accessible depuis n'importe quel appareil.") }}
              </p>
              <div class="absolute -bottom-6 right-4">
                <div class="flex justify-end gap-4 mb-4">
                  <div class="w-16 h-16 rounded-xl bg-tresto-50"></div>
    ...
    <x-front.cta text="Commencez dès aujourd'hui - Améliorez les opérations de votre restaurant"
      cta="Créez un compte GRATUIT maintenant !" />
