...
@section('description', __("Explorez les fonctionnalités puissantes de TResto : création de menus en ligne, génération
  de QR codes, gestion des commandes, et plus encore pour améliorer l'efficacité de votre restaurant."))
