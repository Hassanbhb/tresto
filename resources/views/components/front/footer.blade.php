<section class="pt-24 bg-tresto-600">
  <div class="container mx-auto px-4">
    <div class="bg-tresto-700 rounded-t-3xl flex flex-col gap-28 pt-10 px-10">
      <div class="grid grid-cols-1 lg:grid-cols-12 gap-8">
        ...
        <div class="col-span-4 grid grid-cols-1 lg:grid-cols-4 gap-8 -mx-4">
          <ul class="col-span-1 flex flex-col gap-6 p-4">
