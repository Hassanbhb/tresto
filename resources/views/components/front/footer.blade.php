    ...
    <div class="bg-tresto-700 rounded-t-3xl pt-10 pb-36 px-10">
      <div class="flex justify-between flex-wrap gap-8">
        <div>
          ...
          <p class="text-tresto-200 text-sm"> {{ __("© 2024 Technopek. All rights reserved.")}} </p>
        </div>
        <div class="flex flex-wrap gap-8 -mx-4">
          <ul class="flex flex-col gap-6 p-4">
            ...
            <li><a class="text-tresto-200 hover:text-white transition duration-200" href="{{config('app.url')}}#pricing">{{ __("Pricing")}}</a>
            </li>
          ...
          <ul class="flex flex-col gap-6 p-4">
            ...
            <li><a class="text-tresto-200 hover:text-white transition duration-200" href="https://www.facebook.com/tresto.official/">Facebook</a>
            </li>
            <li><a class="text-tresto-200 hover:text-white transition duration-200" href="https://www.instagram.com/tresto.officiel/">Instagram</a></li>
          </ul>
          <ul class="flex flex-col gap-6 p-4">
            ...
            <li class="flex items-center gap-3">
              ...
              <a class="text-tresto-200 hover:text-white transition duration-200" href="tel:+212664645348">+212 6 64 64 53 48</a>
            </li>
            <li class="flex items-center gap-3">
              <div>
              ...
              <a class="max-w-36 text-tresto-200 hover:text-white transition duration-200" href="https://goo.gl/maps/SBFgmt52ry2dH3im6">Appt3, 1ère étage Imm109 Abdellah Genoun, Hay Essalam, Agadir 80 000, Maroc</a>
            </li>
          </ul>
        </div>
      </div>
